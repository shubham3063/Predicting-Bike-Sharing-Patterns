...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        final_inputs = np.matmul(self.weights_hidden_to_output.T, hidden_outputs) # signals into final output layer
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        output_error_term = error * 1 #final_outputs * (1 - final_outputs) # 1x1
        
        # TODO: Calculate the hidden layer's contribution to the error
        hidden_error = self.weights_hidden_to_output * output_error_term 
        
        
        hidden_error = hidden_error.reshape(hidden_error.shape[0],1)
        ...
        # print(delta_weights_i_h.shape) # 56x2
        # print(delta_weights_h_o.shape) # 2x1
        
        # Weight step (input to hidden)
        delta_weights_i_h += np.matmul(X, hidden_error_term.T) # 56x1 x 1x2 = 56x2
